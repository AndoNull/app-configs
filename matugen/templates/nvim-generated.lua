...
vim.api.nvim_set_hl(0, "SnacksDashboardIcon", { fg = "{{colors.secondary.default.hex}}" })
vim.api.nvim_set_hl(0, "SnacksDashboardDesc", { fg = "{{colors.on_surface.default.hex}}" })
vim.api.nvim_set_hl(0, "SnacksDashboardKey", { fg = "{{colors.tertiary.default.hex}}" })
vim.api.nvim_set_hl(0, "SnacksDashboardFooter", { fg = "{{colors.outline.default.hex}}" })
